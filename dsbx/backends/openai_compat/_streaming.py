...
from dsbx.backends.openai_compat._constants import _RETRIABLE_STATUSES
from dsbx.backends.openai_compat._http import _parse_retry_after
...
class _StreamingMixin:
    ...
    def stream_native(
        ...
        *,
        ...
        :func:`dsbx.core.engine.generate`: for each of the
        ...
        :mod:`dsbx.web.streaming` is unchanged: each chunk
        ...
        and feed them to :mod:`dsbx.core.usage` so the web
