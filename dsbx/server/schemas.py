...
:mod:`dsbx.core.types` and :mod:`dsbx.core.samplers`
...
class WireTokenCandidate(BaseModel):
    """Mirror of :class:`dsbx.core.types.TokenCandidate`.
...
class WireStepResult(BaseModel):
    """Mirror of :class:`dsbx.core.types.StepResult`."""
...
class WireCapabilities(BaseModel):
    """Mirror of :class:`dsbx.core.types.Capabilities`."""
...
class SamplerSpec(BaseModel):
    ...
    :mod:`dsbx.core.samplers`; ``params`` are forwarded as
...
class WireSamplerDecision(BaseModel):
    """Mirror of :class:`dsbx.core.samplers.SamplerDecision`."""
...
class WireGenStep(BaseModel):
    """Mirror of :class:`dsbx.core.engine.GenStep`."""
...
def _safe_logprob(v) -> float | None:
    ...
    ``dsbx/backends/remote.py`` does the reverse.
    """
    f = float(v)
