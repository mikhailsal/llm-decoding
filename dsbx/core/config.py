...
# Repo root = two levels up from this file (dsbx/core/config.py).
...
_DEFAULTS: dict[str, Any] = {
    ...
    # store (see dsbx/web/logging/). When ``enabled`` is true
...
def load_config(
    ...
    *,
    ...
    # ``HF_TOKEN`` in ``dsbx/.env`` expecting it to be honoured;
