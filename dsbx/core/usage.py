...
Concurrency note: the :mod:`dsbx.web.backends` registry holds
...
class UsageAware(Protocol):
    ...
    A caller (typically :mod:`dsbx.web.streaming`) sets the
    ...
    held by :mod:`dsbx.web.backends` makes that easy --
...
def make_sink() -> UsageSink:
    ...
    :class:`dsbx.web.schemas.UsageEvent` model field-for-field
