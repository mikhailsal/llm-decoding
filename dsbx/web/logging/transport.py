...
Installed by :class:`dsbx.web.backends.BackendRegistry` when
...
from dsbx.web.logging.service import enqueue_log

log = logging.getLogger("dsbx.web.logging.transport")
